...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if 'efficientnet' in args.arch:  # NEW
        if args.pretrained:
            model = BA_EfficientNet.from_pretrained(args.arch, advprop=args.advprop)
            print("=> using pre-trained model '{}'".format(args.arch))
        else:
            print("=> creating model '{}'".format(args.arch))
            model = BA_EfficientNet.from_name(args.arch)
    ...
    if 'efficientnet' in args.arch:
        image_size = BA_EfficientNet.get_image_size(args.arch)
    else:
